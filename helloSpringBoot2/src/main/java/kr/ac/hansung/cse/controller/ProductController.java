...
public class ProductController {
	...
	public ResponseEntity<List<Product>> getProductById(@PathVariable("category") String category) {
		
		System.out.println("category="+category);
		List<Product> productData = repository.findByCategory(category);
